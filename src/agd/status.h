...
/// Denotes success or failure of a call in AGD.
class Status {
 public:
...
extern std::string* TfCheckOpHelperOutOfLine(const ::agd::Status& v,
                                             const char* msg);

inline std::string* TfCheckOpHelper(::agd::Status v, const char* msg) {
